...
const sellTransactionModel = transactionModel.discriminator('Sell', sellTransactionSchema);
const buyTransactionModel = transactionModel.discriminator('Buy', buyTransactionSchema);
